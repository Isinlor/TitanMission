...
class SolarSystem extends Bodies {
    ...
    SolarSystem() {
        ...
        super(new HashSet<Body>());

        Set<Body> objects = getBodies();
        ...
        objects.add(
            new Body(
                new Vector(.351343105506232E-03,  7.549817138203992E-03, -4.200718115315673E-05).product(auToM),
        ...
        objects.add(
            new Body(
                new Vector(.619415486257015E+00, -5.067980606649805E+00, 5.724354397991326E-02).product(auToM),
