public class ClosedLoopController extends OpenLoopController{
    ...
    ClosedLoopController(Force slowingDown, Body target, double timetoRunthrough, double timeStep){
        super(slowingDown, target, timetoRunthrough, timeStep);
    }
